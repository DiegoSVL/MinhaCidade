...
<body>
	...
	<div class="container">
		<h1 class="display-4">Listar Demandas</h1>

		<hr class="my-4">

		<form:form method="post" modelAttribute="demandas">
			<div class="form-group wrapper">
				<strong>Título:</strong>
				<input type="text" class="form-control" name="descricao" value="${descricao}" />
			</div>

			<button class="btn btn-primary" formaction="demandas">Consultar</button>
		</form:form>
				...
				<c:forEach items="${demandas}" var="demanda">
					<tr>
						...
						<td class="d-none d-sm-block d-md-none">
							<c:set var="descricao" value="${demanda.descricao}" />
							<c:choose>
						...
						<td><a class="btn btn-outline-primary btn-sm" href="/detalharDemanda/${demanda.id}">Detalhar</a></td>
						<td><a class="btn btn-outline-primary btn-sm" href="/excluirDemanda/${demanda.id}">Excluir</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
		...
		<div>
			<a class="btn btn-primary" href="/criarDemanda">Criar demanda</a>
		</div>
	</div>
